...
/**
 * Weave example app for a single-pass middleware stack.
 */
...
{
	use \Weave\Weave;
	use \Weave\Config\Laminas\Laminas;
	use \Weave\Error\Whoops\Whoops;
	use \Weave\Container\Aura\Aura;
	...
	/**
	 * Provide middleware pipeline sets for Middleman Middleware.
	 *
	 * This app uses Middleman for the Middleware stack (see App\Config for the DIC setup that
	 * does this). Middleman accepts an array of class name strings, invokable class instances
